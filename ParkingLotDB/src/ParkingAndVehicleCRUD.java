...
public class ParkingAndVehicleCRUD {
    ...
    private static void addParkingLot(Scanner scanner) {
        ...
        // You can execute this query using a database connection
    ...
    private static void readParkingLots() {
        ...
        printArrayList(db.readAllRows("parking_lots", new String[]{"parking_lot_id", "name", "street", "city", "state", "zip_code", "capacity"}));
    }
    ...
    private static void readVehicles() {
        ...
        printArrayList(db.readAllRows("vehicles", new String[]{"license_plate", "state", "parking_lot_id", "color", "make", "model"}));
    }
